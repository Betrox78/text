...
import database.rental.RentalEvidenceDBV;
 ...
 * @author ulises
 */
public class RentalEvidenceSV extends ServiceVerticle {

    @Override
    protected String getDBAddress() {
        return RentalEvidenceDBV.class.getSimpleName();
    }

    @Override
    protected String getEndpointAddress() {
        return "/rentalEvidences";
    }
    ...
    protected boolean isValidUpdateData(RoutingContext context) {
        ...
        try {
            UtilsValidation.isBoolean(body, "was_departure");
