...
import database.boardingpass.BoardingPassSpecialTicketDBV;
 ...
 * @author ulises
 */
public class BoardingPassSpecialTicketSV extends ServiceVerticle {

    @Override
    protected String getDBAddress() {
        return BoardingPassSpecialTicketDBV.class.getSimpleName();
    }

    @Override
    protected String getEndpointAddress() {
        return "/boardingPassesSpecialTickets";
    }
