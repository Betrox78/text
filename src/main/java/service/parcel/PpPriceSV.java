...
public class PpPriceSV extends ServiceVerticle {

    @Override
    protected String getDBAddress() {
        return PpPriceDBV.class.getSimpleName();
    }
    ...
    public void register(RoutingContext context) {
        ...
        try {
            ...
            DeliveryOptions options = new DeliveryOptions().addHeader(ACTION, PpPriceDBV.REGISTER);
