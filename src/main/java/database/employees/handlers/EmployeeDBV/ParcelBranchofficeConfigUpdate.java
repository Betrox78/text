...
public class ParcelBranchofficeConfigUpdate extends DBHandler<EmployeeDBV> {

    public ParcelBranchofficeConfigUpdate(EmployeeDBV dbVerticle) {
        super(dbVerticle);
    }
    ...
    public void handle(Message<JsonObject> message) {
        ...
        try {
            ...
            GenericQuery update = this.generateGenericUpdate("parcels_branchoffices_init_config", body, true);
