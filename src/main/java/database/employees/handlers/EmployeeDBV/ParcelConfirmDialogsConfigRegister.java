...
public class ParcelConfirmDialogsConfigRegister extends DBHandler<EmployeeDBV> {

    public ParcelConfirmDialogsConfigRegister(EmployeeDBV dbVerticle) {
        super(dbVerticle);
    }
    ...
    public void handle(Message<JsonObject> message) {
        ...
        try {
            GenericQuery insert = this.generateGenericCreate("parcels_confirm_dialogs_init_config", body);
