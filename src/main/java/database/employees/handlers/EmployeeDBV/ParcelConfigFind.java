...
public class ParcelConfigFind extends DBHandler<EmployeeDBV> {

    public ParcelConfigFind(EmployeeDBV dbVerticle) {
        super(dbVerticle);
    }
    ...
    private static final String QUERY_GET_BY_EMPLOYEE_ID = "SELECT * FROM parcels_init_config WHERE employee_id = ?";
