-- 1632766954 DOWN cancel-parcels-27-sep-2021
...
update parcels set parcel_status = 0 where parcel_tracking_code = "G2109D3F66F";

update parcels_packages set package_status = 0 where parcels_id = (select id from parcels where parcel_tracking_code = "G2109D3F66F");