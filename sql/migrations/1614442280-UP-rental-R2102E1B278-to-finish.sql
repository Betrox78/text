-- 1614442280 UP rental-R2102E1B278-to-finish
...
UPDATE rental set   kilometers_init = 100 , kilometers_end = 110 , rent_status = 3 , penalty_days = 0 , received_at = "2021-02-28 21:36:00" , received_by = (select id from users where email = "igalaviz@allabordo.com") , delivered_at = "2021-02-28 21:36:00" , delivered_by =  (select id from users where email = "igalaviz@allabordo.com")  where reservation_code = "R2102E1B278" ;


UPDATE rental set payment_status = '1' where reservation_code = "R2102E1B278" ;
...
, (select id from rental where reservation_code = "R2102E1B278")
, 578.21
, 9192
, 9192
, 0.00
...
values ( 5000 , true , 1 , 22 , false , ( select id from users where email = "igalaviz@allabordo.com" ) , (select id from rental where reservation_code = "R2102E1B278") , (SELECT @idTicket) ,'cash' );
SET @idPaymentGarantia = (SELECT last_insert_id());

insert into payment(amount,is_deposit,payment_method_id,currency_id,is_extra_charge,created_by,rental_id,ticket_id,payment_method)
values ( 4192 , false , 1 , 22 , false , ( select id from users where email = "igalaviz@allabordo.com" ) , (select id from rental where reservation_code = "R2102E1B278") , (SELECT @idTicket) ,'cash' );
...
values ( (select id from rental where reservation_code = "R2102E1B278") , 10 , 6 , 0 , 0 , 6 , 0 , 0.0 , 0.0 , 1 , 1 , ( select id from users where email = "igalaviz@allabordo.com" ) );
