-- 1617035185 UP rental-R21018BA8D3-to-finish

-- select * from rental where reservation_code = "R2103DF8236";

UPDATE rental set kilometers_init = 100 , kilometers_end = 110 , rent_status = 3 , penalty_days = 0 , received_at = "2021-03-21 06:01:00" , received_by = (select id from users where email = "igalaviz@allabordo.com") , delivered_at = "2021-03-14 06:03:00" , delivered_by =  (select id from users where email = "igalaviz@allabordo.com")   where reservation_code = "R2103DF8236" ;

UPDATE rental set payment_status = '1' where reservation_code = "R2103DF8236" ;
...
values ( (select id from rental where reservation_code = "R2103DF8236") , 10 , 6 , 0 , 0 , 6 , 0 , 0.0 , 0.0 , 1 , 1 , ( select id from users where email = "igalaviz@allabordo.com" ) );
...
, (select id from rental where reservation_code = "R2103DF8236")
, 0
, 5000
, 5000
, 0.00
